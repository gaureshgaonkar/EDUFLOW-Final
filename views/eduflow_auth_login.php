...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .btn-signup-nav { background-color: #238636; color: #ffffff; }
        .btn-signup-nav:hover { background-color: #2ea043; }
        ...
        /* Actions & Links */
        .btn-submit { width: 100%; padding: 11px; background-color: #1f6feb; color: #ffffff; border: none; border-radius: 6px; font-size: 15px; font-weight: 600; cursor: pointer; margin-top: 10px; }
        .btn-submit:hover { background-color: #388bfd; }

        .forgot-link { display: block; text-align: left; margin-top: 16px; font-size: 14px; color: #58a6ff; text-decoration: none; }
        ...
        .alert-success { background-color: rgba(46, 160, 67, 0.1); border: 1px solid rgba(46, 160, 67, 0.4); color: #3fb950; padding: 12px; border-radius: 6px; font-size: 14px; margin-bottom: 18px; }
    </style>
</head>
<body>
    ...
    <div class="top-nav">
        ...
        <a href="eduflow_auth_index.php?action=register" class="btn-signup-nav">Sign Up</a>
    </div>
   ...
   <!-- Black Form Card Box -->
    <div class="card">
        ...
        <?php if (isset($_GET['registered'])): ?>
            <div class="alert-success">Account created successfully! Please sign in.</div>
        <?php endif; ?>

        <?php if (isset($_GET['reset_success'])): ?>
            <div class="alert-success">Password reset successfully! Please sign in with your new password.</div>
        <?php endif; ?>

        <form action="eduflow_auth_index.php?action=login" method="POST">
        ...
        <a href="eduflow_auth_index.php?action=request_password_reset" class="forgot-link">Forgot Password?</a>
    </div>
